...
logger = logging.getLogger("talentree.services.search")
...
def search_web_tool(query: str, country_code: str = "EG") -> str:
    ...
    cached_val = redis_mgr.get_cache(cache_key) or redis_mgr.get_semantic_cache(cache_key)
    if cached_val:
    ...
    if serper_key:
        try:
            ...
            if resp.status_code == 200:
                ...
                # Cache the results
                redis_mgr.set_cache(cache_key, res_str, expire_seconds=86400) # 24 hrs
